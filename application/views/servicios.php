      ...
      <nav class="top-bar fixed" data-topbar role="navigation">
        ...
        <section class="top-bar-section">
          ...
          <ul class="right">
            ...
            <li class="active"><a href="http://sereteli.coredev.io/index.php/servicios">Servicios</a></li>
        ...
        <div id="contenido_video">
            <div class="row">
                ...
                <div class="container text-center">
                    <!-- <img src="http://sereteli.coredev.io/assets/img/mit.png"  /> -->
                </div>
            </div>
        </div>
...
<div class="pymes2">
  <div class="row">
  <div class="small-12 medium-4 large-4 columns"><center><img src="http://sereteli.coredev.io/assets/img/mit.png"/></center></div>
...
<div class="pymes3">
  ...
  <div class="small-12 medium-4 large-4 columns"><center><img src="http://sereteli.coredev.io/assets/img/nec.png"/></center></div>
  </div>
...
<script>
            $(document).ready(function() {
                $('#video2').videobackground({
                    videoSource: [['http://sereteli.coredev.io/video.mp4', 'video/mp4']],
